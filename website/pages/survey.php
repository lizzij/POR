                ...
                <div class="trustOption">
                  ...
                  <div class="slidecontainer">
                    <div class="form-group" style="margin-bottom:0; margin-bottom:0px">
                      ...
                      <output class="sliderAmount" name="stateAmount" id="stateAmount" for="rangeInput">0</output>
                    </div>
                  </div>
                </div>
                ...
                <div class="trustOption">
                  ...
                  <div class="form-group" style="margin-bottom:0px; margin-bottom:0px">
                    <div class="slidecontainer">
                      ...
                      <output class="sliderAmount" name="privateAmount" id="privateAmount" for="rangeInput">0</output>
                    </div>
                  </div>
                </div>
                ...
                <div class="trustOption">
                  ...
                  <div class="form-group" style="margin-bottom:0px">
                    <div class="slidecontainer">
                      ...
                      <output class="sliderAmount" name="foreignAmount" id="foreignAmount" for="rangeInput">0</output>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="question">
            ...
            <div class="questionAnswer">
              <div class="form-group" style="margin-top:5px; margin-bottom:0px">
                <input type="text" class="form-control" id="univerisity" name="uni" onfocus="this.placeholder = ''" placeholder="复旦大学" style="font-size: 10px;">
              </div>
            </div>
          </div>
        </div>
...
<?php
  $db = mysqli_connect("localhost","root", "m7#C#v(tsrt2fRj@","test")
  or die('Error connecting to MySQL server.');

  $hukou = $db->real_escape_string($_POST['hukou']);
  $stateAmount = $db->real_escape_string($_POST['stateAmount']);
  $privateAmount = $db->real_escape_string($_POST['privateAmount']);
  $foreignAmount = $db->real_escape_string($_POST['foreignAmount']);
  $uni = $db->real_escape_string($_POST['uni']);

  // $sql = "INSERT INTO surveyPage1Test (Hukou, TrustState, TrustPrivate, TrustForeign, Uni)
  // VALUES ('$hukou', '$stateAmount', '$privateAmount', '$foreignAmount', '$uni')";
